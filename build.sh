...
# Add the .wasm module to a js file for use in other modules
echo "export var WASM_BINARY_INLINED = '$(base64 -w 0 jsmpeg.wasm)';" \
	> src/jsmpeg.wasm.js

# Add the default export
echo "export default WASM_BINARY_INLINED;" >> src/jsmpeg.wasm.js
